...
def test_the_temporal_term_is_weighted_to_be_worth_optimising() -> None:
    ...
    that way until it measured the temporal term stopping at epoch 2 and
    contributing ~1.5% of the total loss at alpha=0.2.

    0.8 is a departure from RhythmFormer, on that measurement. ARCHITECTURE.md
    section 6 records it."""
